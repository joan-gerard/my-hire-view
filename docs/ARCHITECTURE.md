...
| `/pricing`          | Pricing page (E3-014): compact intro band + Free/Pro/Premium draft tiers (`components/public/pricing/`), waitlist CTA, footer. Same `MarketingHeader` as `/` (solid header — no fixed full-viewport hero). Caps/prices still TBD per [PRICING_AND_MEMBERSHIP.md](PRICING_AND_MEMBERSHIP.md).                                                                                                                                                                                                                      | No   |
