...
| `/pricing`          | Pricing page (E3-014): compact intro + Free/Pro/Premium tiers with locked monthly USD prices (`components/public/pricing/`), glossary, caps FAQ, waitlist CTA, footer. Same `MarketingHeader` as `/` (solid header — no fixed full-viewport hero). Matrix in [PRICING_AND_MEMBERSHIP.md](PRICING_AND_MEMBERSHIP.md); checkout still E2.                                                                                                                                                                                                                      | No   |
