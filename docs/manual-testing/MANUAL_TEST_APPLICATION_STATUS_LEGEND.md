...
- [ ] On open, focus moves into the modal on the heading (not the Close button). Mouse open should not show a selection-style ring; a `focus-visible` outline remains available for keyboard focus indication
