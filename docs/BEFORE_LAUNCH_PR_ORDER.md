...
**15 open** (F9, F10, F11, F12, F13, F15, F16, F18, F25, F26 shipped). **Weighted average ≈ 2.80** — many 1–3 polish items; complexity concentrates in **E2**, then **F17 / F21 / F29 / I2**.
...
If capacity is short: start **F19**.
