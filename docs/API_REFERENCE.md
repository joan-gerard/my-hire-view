...
- Zod body validation (`loginBodySchema`); malformed JSON → **400** “Invalid JSON body” (F1-040).
...
- Zod body validation (`signupBodySchema`) + shared password helper used by the signup form (F1-040, F1-041).
