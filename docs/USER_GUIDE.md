...
6. Click **Save Draft**. You are taken to a **preview** of the public page (same link recruiters will use later). Recruiters still cannot see it until you publish. Use **Publish** on the preview banner or on the dashboard card when it looks right. Until then the card shows **Publish to share** instead of **Copy Link**.
