...
5. Progress on this form is **remembered in this browser** if you refresh or leave and come back (up to about a week). After a successful Save, the draft is cleared. A tailored PDF file itself is not restored — re-choose the file if you had one selected.
