...
Result: end-to-end flow: sign up/in, create/edit applications (slug, CV, video, description), shareable `/apply/[slug]` page with view tracking, Supabase + CV storage (Cloudflare R2).
