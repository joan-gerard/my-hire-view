...
| File | What it covers |
|------|---------------|
| `__tests__/unit/components/public/pricing-tiers.test.ts` | **Pricing tiers (E3-014)** — Free/Pro/Premium ids & names, Pro highlighted, locked monthly USD ($9 / $19), video pitch, firm caps, glossary/FAQ, waitlist CTAs |
