...
| `__tests__/unit/lib/utils/upload-form-messages.test.ts` | **Upload Save UX helpers (F8)** — friendly **400**/**401**/**409**/**429**/**5xx**/network copy; CV idempotency key reuse vs rotate on file change |
