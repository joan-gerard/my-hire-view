...
- **Marketing site** (`/`) — home, pricing (Free/Pro/Premium with locked monthly USD prices; checkout still E2), waitlist signup. Currently in pre-launch mode. (`/how-it-works` and `/blog` removed pre-launch; rebuild later via J3.)
