...
- **Marketing site** (`/`) — home, pricing (draft Free/Pro/Premium tiers), waitlist signup. Currently in pre-launch mode. (`/how-it-works` and `/blog` removed pre-launch; rebuild later via J3.)
