...
| F20-019 | Legal       | Create legal pages                                        | Terms of Service, Privacy Policy, and Cookies (`/terms`, `/privacy`, cookies). Footer and waitlist already link to `/terms` and `/privacy` with no pages. **Context:** the marketing homepage was built from a **Framer template that was modified** — keep that origin in mind for layout/styling consistency with marketing, and for any license/attribution obligations the template requires when drafting legal copy. | —                                                                      |
