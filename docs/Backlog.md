...
| F19-044 | UX          | New-user onboarding checklist                             | Checklist / workflow for new users (e.g. fill profile, upload photo, create first application) — shown until steps are complete. Complementary guided tour after launch: `F31-105`.                                                                                                                                                                                                                              | —                                                                      |
...
| F19-047 | UX          | Application card icon / badge legend                      | On `/admin`, each application card shows a left-side icon/badge with no explanation. Add UI (tooltip, legend, or inline help) so users know what each icon means — **draft**, **active (not viewed)**, **active (viewed)**, **archived** (and CV-missing if shown). After `F16-050`, draft vs active must stay clearly distinct; also clarify draft card actions in that help (Publish / Preview vs Copy Link). Brand colors/chrome for cards belong in `F17-017`.                                                                                                                                                                                          | —                                                                      |
...
1. Continue the phased sequence in [BEFORE_LAUNCH_PR_ORDER.md](BEFORE_LAUNCH_PR_ORDER.md) — next: **F19** (onboarding + Public id + legend)  
