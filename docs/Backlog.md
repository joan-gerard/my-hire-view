...
| ID      | Subcategory | Item                                                      | Notes                                                                                                                                                                                                                                                                                                                                                                                                                      | Source                                                                 |
| ------- | ----------- | --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| F17-017 | Branding    | Update `/admin` and `/view` branding                      | Still on previous visual identity. Include loading effects / skeletons so they match the new brand (not leftover styles). **Dashboard application cards:** restyle status icon colors, card chrome, and primary/secondary button look to the new brand (visual skin only — action hierarchy / legend copy shipped in `F19-047`).                                                                                                                                                                  | [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md)                             |
