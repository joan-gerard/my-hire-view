...
| F15-045 | UX          | Persist create-application form draft                     | Keep create-application form data until submit so refresh doesn’t lose progress; intentional Back / nav leave confirms and **discards** the local draft (see retrospective).                                                                                                                                                                                                                                              | [CREATE_APP_DRAFT_AND_LEAVE.md](retrospectives/CREATE_APP_DRAFT_AND_LEAVE.md) |
...
1. Continue the phased sequence in [BEFORE_LAUNCH_PR_ORDER.md](BEFORE_LAUNCH_PR_ORDER.md) — next: **F15** (create-app draft + CV-mode race)  
