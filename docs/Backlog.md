...
1. **F13** (atomic primary-library cap)  
2. Continue the phased sequence in [BEFORE_LAUNCH_PR_ORDER.md](BEFORE_LAUNCH_PR_ORDER.md) (create UX → trust → audits)  
3. **Before F30:** `I2`, `L6` (targeted code-quality / refactor; `F5`, `F25` shipped)  
