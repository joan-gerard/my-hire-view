...
export function FAQContactCard() {
  return (
    <div className="relative xl:aspect-auto flex flex-col p-10 gap-6 xl:gap-0 justify-center lg:justify-between w-full overflow-hidden lg:col-span-1 bg-slate-600 text-white rounded-3xl">
