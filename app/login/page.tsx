...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // The browser will store them, so the next request to /admin includes them.
      ...
      // Cookies are set by the response headers; redirect immediately
      // The browser will store Set-Cookie headers and send them with the next request
      window.location.href = '/admin';
    } catch (err) {
